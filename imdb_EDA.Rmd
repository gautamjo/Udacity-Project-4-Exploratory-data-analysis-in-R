...
<h3><span style = "color:olive">Prelude:</span></h3>  
What makes movies good or bad? Is it our emotional response towards them? Is it the critical reviews or the scores? Is it the association of popular directors or actors? Is it the amount it grosses at the box office? What is it really that describes its success or failure? I have pondered over such questions many a times but never really got around to acknowledge them. Thus, when this project came along, I used it as an opportunity to try to find some answers this time around.<br>
...
<li><span style = "color:cadetblue">color:</span> Specifies whether the movie is black and white or color</li>  
...
<li><span style = "color:cadetblue">country:</span> Contains the name of the country in which a movie is made</li>   
...
<h3><span style = "color:olive">Purpose:</span></h3>  
...
<h3><span style = "color:olive">Setup:</span></h3>  
...
df <- mdata %>%
  head(20) %>%
  formattable(align = "l") %>%
  datatable(options = list(scrollX='400px'), filter = "top")
df
```  
...
<h3><span style = "color:olive">Section Overview</span></h3>  
...
<h3><span style = "color:olive">Act 2: Trends and Relationships</span></h3>
...
<h3><span style = "color:olive">Act 3: The Last Enquiry</span></h3>  
...
data_by_title_year %>%
  ...
  as.datatable(options = list(pageLength=100, scrollX='400px'), filter = "top")
...
genre_wise_data %>%
  ...
  as.datatable(options = list(pageLength=10, scrollX='400px'), filter = "top")
```
...
<h3><span style = "color:olive">Overview</span></h3>  
...
<h3><span style = "color:olive">Extras: Final Plots and Summary</span></h3>
...
<h3><span style = "color:olive">Reflection</span></h3>  
